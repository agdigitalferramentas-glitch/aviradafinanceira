...
const Opm0526 = () => {
  ...
  return (
    <main className="opm0526-theme min-h-screen bg-background text-foreground">
      ...
      {/* HERO */}
      <section className="relative overflow-hidden min-h-screen flex items-center pt-[250px] pb-[3.2rem] lg:pt-20 lg:pb-24">
        <img
        ...
        >
          <div>
            ...
            <p className="mt-4 text-xs text-muted-foreground uppercase tracking-wider text-center md:text-left">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {benefits.map((b, i) => {
              ...
              return (
                <div
                  key={i}
                  className="glass-card dark-card rounded-2xl p-7 transition-all duration-300 hover:-translate-y-1 hover:border-primary"
                >
      ...
      {/* ABOUT BRUNO */}
      <section id="bruno" className="pt-[5.12rem] md:pt-48 pb-[1.6rem] md:pb-24">
        <div
          ref={aRef}
        ...
        >
          <div className="grid md:grid-cols-3 gap-8 md:gap-0 items-center">
            <div className="order-1 md:order-2 relative z-10 md:scale-150 md:origin-right">
      ...
      {/* FAQ */}
      <section id="faq" className="pt-[3.2rem] md:pt-48 pb-[3.2rem] md:pb-24">
        <div
          ref={fRef}
      ...
      <section className="py-[3.2rem] md:py-24">
        ...
        >
          <div className="glass-card rounded-3xl p-10 md:p-16 text-center relative overflow-hidden border-primary/40">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] h-[400px] rounded-full bg-primary/5 blur-[120px]" />
